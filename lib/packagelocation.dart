...
//Bottom NavBar
export 'package:evento_firsttry/views/navbar.dart';
...
export 'package:evento_firsttry/views/wishlist.dart';

export 'package:evento_firsttry/model/login.dart';
export 'package:evento_firsttry/controller/logincontroller.dart';
